...
- [ ] Un changement de la liste de conteneurs (ajout / suppression / état) est
      détecté et déclenche un seul point d'entrée explicite.
- [ ] Tests : checksum sensible aux changements attendus, insensible au bruit ;
      la boucle survit à un rejet du client Docker et ré-arme son tick.
- [ ] Plus aucun appel à `sha256()` sans argument dans le code.
- [ ] Doc du cycle de rafraîchissement à jour, `npm run verify` vert.
